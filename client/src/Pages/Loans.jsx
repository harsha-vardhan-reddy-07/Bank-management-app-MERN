...
const Loans = () => {
    ...
    useEffect(()=>{
      ...
      const createNewLoan = async () =>{
        ...
        const newLoanDetails = {loanType: newLoanType, customerId: userid, customerName: username, nomineeName: newNomineeName, nomineeAge: newNomineeAge, duration: newLoanDuration, loanAmount: newLoanAmount, createdDate: new Date()};
