...
const Deposits = () => {
    ...
    useEffect(()=>{
      ...
      const createNewDeposit = async () =>{
        ...
        const newDepositDetails = {depositName: newDepositName, depositType: newDepositType, customerId: userid, 
      ...
      <div className="user-deposits-page">
                    ...
                    return(
                        ...
                        <div className="user-deposit" >
                            ...
                            <span>
                                ...
                                <p><b>Nominee: </b> {deposit.nomineeName} </p>
                                <p><b>Age: </b>{deposit.nomineeAge}</p>
                            </span>
                            <span>
          ...
          <div className="user-deposits-container2">
              ...
              <div className="new-user-deposits-container">
                  ...
                  <select className="form-select" aria-label="Default select example" value={newDepositType}  onChange={(e)=> setNewDepositType(e.target.value)}>
                      <option selected value="">Choose deposit type</option>
