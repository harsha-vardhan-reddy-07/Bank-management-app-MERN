...
const Deposits = () => {
    ...
    useEffect(()=>{
      ...
      const createNewDeposit = async () =>{
        ...
        const newDepositDetails = {depositName: newDepositName, customerId: userid, customerName: username, nomineeName: newNomineeName, nomineeAge: newNomineeAge, duration: newDepositDuration, amount: newDepositAmount, createdDate: new Date()};
